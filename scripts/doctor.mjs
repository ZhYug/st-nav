...
console.log('🔎 ST Nav v1.1.6 Pages Advanced Mode 检查\n');
...
if (existsSync('package.json')) {
  ...
  if (pkg.version !== '1.1.6') fail('package.json 版本号不是 1.1.6');
...
if (existsSync('public/_worker.js')) {
  ...
  if (!worker.includes('const VERSION = "1.1.6"')) fail('Worker 版本号不是 1.1.6');
